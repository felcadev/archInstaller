...
# -*- coding: utf-8 -*-
#
# Copyright (c) Pichaosdev <pipechaosdev@gmail.com>
#
# Github: https://github.com/pichaosdev/archInstaller
#
...
def convert(input_pkg, output_pkg=''):
    ...
    try:
        ...
        print()
        print('*** Installing: ' + output_pkg + ' ...')
        subprocess.call('sudo pacman -U '+ output_pkg, shell=True)
